		...
		return (
			<div>
				...
				<p>
					...
					and particularly Spider-Man comics that I have read since I was a
					child. My first software development app that I ever created using
					HTML, CSS, and JavaScript was a trivia app about the legend himself.
				</p>
				<p>
					...
					are spoken and travelled to many more. While in Graduate School to
				...
				<p>
					...
					applications I've created, my resume, and my travel blog which also
					includes my award-winning post about my study abroad in Brazil. If you
					are looking to connect, please
				</p>
			</div>
		);
	}
